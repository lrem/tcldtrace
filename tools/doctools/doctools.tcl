...
proc ::doctools::SetupFormatter {name format} {
    ...
    if {[info exists ::env(DOCTOOLS_NROFF_INCLUDE)]} {
	interp alias $mpip get_nr_include {} ::doctools::get_nr_include
    }
...
if {[info exists ::env(DOCTOOLS_NROFF_INCLUDE)]} {
    proc ::doctools::get_nr_include {file} {
	set f [open [file join $::env(DOCTOOLS_NROFF_INCLUDE) $file]]
